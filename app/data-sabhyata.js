...
window.IND_SABHYATA = {
  ...
  sites: [
    ...
    { id: 'delhi', lab: 'w', era: 5, name: 'Delhi', state: 'DL', x: 326.4, y: 347.0, kind: 'shilpa',
      ...
      sources: ['NCERT, Our Pasts II, ch. "The Delhi Sultans"', 'ASI Qutb complex literature; UNESCO World Heritage listing (1993)'] },
    { id: 'hampi', era: 6, name: 'Hampi', state: 'KA', x: 302.2, y: 806.9, kind: 'shilpa',
      ...
      sources: ['NCERT, Our Pasts II (Vijayanagara)', 'Travel accounts of Abdur Razzaq and Domingo Paes; UNESCO listing (1986)'] },
    { id: 'agra', lab: 'e', era: 7, name: 'Agra', state: 'UP', x: 351.0, y: 400.4, kind: 'shilpa',
      ...
      sources: ['NCERT, Our Pasts II', 'ASI Taj Mahal literature; UNESCO listing (1983)'] },
    { id: 'amritsar', era: 7, name: 'Amritsar', state: 'PB', x: 252.0, y: 237.0, kind: 'kheti',
      ...
      sources: ['Sikh tradition as the community keeps it (docs/05 §4 — from the inside)', 'NCERT, Our Pasts II'] },
    { id: 'surat', era: 8, name: 'Surat', state: 'GJ', x: 187.6, y: 610.7, kind: 'shilpa',
      ...
      sources: ['NCERT, Our Pasts II, ch. "Towns, Traders and Crafts-persons" (Surat)', 'Seventeenth-century travel accounts (Ovington and others)'] },
    { id: 'mumbai', lab: 's', era: 9, name: 'Bombay', state: 'MH', x: 187.7, y: 686.5, kind: 'shilpa',
      ...
      sources: ['Indian Railways history (Bombay–Thane, 1853)', 'NCERT, India and the Contemporary World; UNESCO listing for the terminus (2004)'] },
    { id: 'kolkata', lab: 'e', era: 9, name: 'Calcutta', state: 'WB', x: 677.9, y: 562.4, kind: 'vidya',
      ...
      sources: ['NCERT, India and the Contemporary World II (print culture)', 'Howrah Bridge (1943) engineering records'] },
    { id: 'ahmedabad', lab: 'w', era: 10, name: 'Ahmedabad', state: 'GJ', x: 179.4, y: 546.9, kind: 'vidya',
      ...
      sources: ['NCERT, India and the Contemporary World II (Civil Disobedience, 1930)', 'Sabarmati Ashram Preservation and Memorial Trust'] },
    { id: 'chandigarh', era: 11, name: 'Chandigarh', state: 'CH', x: 312.2, y: 270.6, kind: 'shilpa',
      ...
      sources: ['Chandigarh Capitol Complex records (the Le Corbusier plan)', 'UNESCO World Heritage listing (2016)'] },
    { id: 'bengaluru', era: 12, name: 'Bengaluru', state: 'KA', x: 337.9, y: 884.7, kind: 'vidya',
      ...
      sources: ['Indian Institute of Science history (founded 1909)', 'docs/16 takeoff-era sources (the Itihaas pack)'] },
    { id: 'sriharikota', lab: 'e', era: 12, name: 'Sriharikota', state: 'AP', x: 421.3, y: 859.7, kind: 'vidya',
      ...
      sources: ['ISRO: SLV-3 and Rohini (18 July 1980); Satish Dhawan Space Centre SHAR'] }
  ],
