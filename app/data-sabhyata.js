...
window.IND_SABHYATA = {
  ...
  sites: [
    ...
    { id: 'hastinapura', era: 1, name: 'Hastinapura', state: 'UP', x: 351.4, y: 328.6, kind: 'kheti',
      ...
      sources: ['B. B. Lal, ASI Hastinapura excavations (1950–52; the flood layer and the Painted Grey Ware)', 'Mahabharata (Katha frame — the story, as it is told)'] },
    { id: 'kashi', era: 1, name: 'Kashi', state: 'UP', x: 508.7, y: 466.6, kind: 'vidya',
      ...
      sources: ['NCERT, Our Pasts I', 'ASI Rajghat excavation literature', 'Jataka tales (Kasi cloth); Sarnath lion capital (the State Emblem of India)'] },
    ...
    { id: 'vaishali', era: 1, name: 'Vaishali', state: 'BR', x: 575.8, y: 442.8, kind: 'kheti',
      ...
      sources: ['NCERT, Our Pasts I, ch. on early republics (gana-sanghas)', 'ASI Vaishali site literature; the Kolhua pillar', 'Jain tradition on Mahavira’s birthplace (Katha frame — as the community tells it)'] },
    ...
    { id: 'pataliputra', lab: 'w', era: 2, name: 'Pataliputra', state: 'BR', x: 576.0, y: 456.8, kind: 'vidya',
      ...
      sources: ['NCERT, Our Pasts I, ch. on the Mauryas', 'Megasthenes’ Indica (as preserved in later Greek writers)', 'ASI Kumhrar excavations (the 80-pillared hall)'] },
    { id: 'sanchi', era: 2, name: 'Sanchi', state: 'MP', x: 342.5, y: 531.0, kind: 'shilpa',
      ...
      sources: ['ASI Sanchi; UNESCO World Heritage listing', 'NCERT, Our Pasts I', 'South gateway inscription (the gift of the ivory-workers of Vidisha)'] },
    ...
    { id: 'sopara', era: 2, name: 'Sopara', state: 'MH', x: 186.6, y: 670.3, kind: 'shilpa',
      ...
      sources: ['ASI Sopara (Shurparaka) finds, incl. the VIII rock edict fragment', 'Periplus of the Erythraean Sea (as “Ouppara”)', 'Bhagwanlal Indraji’s 1882 stupa excavation (the nested relic caskets)'] },
    ...
    { id: 'nalanda', lab: 'e', era: 3, name: 'Nalanda', state: 'BR', x: 585.7, y: 473.0, kind: 'vidya',
      ...
      sources: ['Xuanzang’s account (Si-yu-ki), incl. the gate examinations', 'ASI Nalanda; UNESCO World Heritage listing', 'NCERT, Our Pasts I'] },
    ...
    { id: 'mathura', lab: 'e', era: 3, name: 'Mathura', state: 'UP', x: 340.4, y: 389.1, kind: 'shilpa',
      ...
      sources: ['Mathura school of sculpture (standard art-history literature)', 'Krishna tradition (Katha frame — the story, as it is told)', 'Government Museum, Mathura (the Kanishka statue)'] },
    ...
    { id: 'mamallapuram', lab: 'e', era: 4, name: 'Mamallapuram', state: 'TN', x: 419.9, y: 896.3, kind: 'shilpa',
      ...
      sources: ['ASI Mamallapuram; UNESCO World Heritage listing', 'NCERT, Our Pasts II', 'ASI / press reports on the 2004 tsunami finds'] },
    { id: 'thanjavur', era: 4, name: 'Thanjavur', state: 'TN', x: 386.7, y: 956.0, kind: 'vidya',
      ...
      sources: ['Brihadisvara temple inscriptions (ASI; the 400 dancers and 200 musicians are inscriptional)', 'UNESCO World Heritage listing', 'NCERT, Our Pasts II, ch. on the Cholas'] },
    ...
    { id: 'muziris', lab: 'w', era: 4, name: 'Muziris', state: 'KL', x: 293.8, y: 973.9, kind: 'kheti',
      ...
      sources: ['Periplus of the Erythraean Sea; Pliny, Natural History', 'Akananuru 149 (the Muciri poem); Pattanam excavation literature (the identification is discussed)', 'The Muziris papyrus (P. Vindob. G 40822)'] },
    ...
    { id: 'delhi', lab: 'w', era: 5, name: 'Delhi', state: 'DL', x: 326.4, y: 347.0, kind: 'shilpa',
      ...
      sources: ['NCERT, Our Pasts II, ch. "The Delhi Sultans"', 'ASI Qutb complex literature; UNESCO World Heritage listing (1993)', 'Iron Pillar corrosion studies (IIT Kanpur / R. Balasubramaniam)'] },
    { id: 'hampi', era: 6, name: 'Hampi', state: 'KA', x: 302.2, y: 806.9, kind: 'shilpa',
      ...
      sources: ['NCERT, Our Pasts II (Vijayanagara)', 'Travel accounts of Abdur Razzaq and Domingo Paes; UNESCO listing (1986)', 'Krishnadevaraya, Amuktamalyada (the rajadharma verses)'] },
    ...
    { id: 'mumbai', lab: 's', era: 9, name: 'Bombay', state: 'MH', x: 187.7, y: 686.5, kind: 'shilpa',
      ...
      sources: ['Indian Railways history (Bombay–Thane, 1853)', 'NCERT, India and the Contemporary World; UNESCO listing for the terminus (2004)', 'Phalke, Raja Harishchandra (1913)'] },
    { id: 'kolkata', lab: 'e', era: 9, name: 'Calcutta', state: 'WB', x: 677.9, y: 562.4, kind: 'vidya',
      ...
      sources: ['NCERT, India and the Contemporary World II (print culture)', 'Howrah Bridge (1943) engineering records', 'University of Calcutta (est. 1857)'] },
    { id: 'ahmedabad', lab: 'w', era: 10, name: 'Ahmedabad', state: 'GJ', x: 179.4, y: 546.9, kind: 'vidya',
      ...
      sources: ['NCERT, India and the Contemporary World II (Civil Disobedience, 1930)', 'Sabarmati Ashram Preservation and Memorial Trust', 'Sidi Saiyyed mosque (1573) — the jali'] },
    { id: 'chandigarh', era: 11, name: 'Chandigarh', state: 'CH', x: 312.2, y: 270.6, kind: 'shilpa',
      ...
      sources: ['Chandigarh Capitol Complex records (the Le Corbusier plan)', 'UNESCO World Heritage listing (2016)', 'Nek Chand Rock Garden Trust'] },
    { id: 'bengaluru', era: 12, name: 'Bengaluru', state: 'KA', x: 337.9, y: 884.7, kind: 'vidya',
      ...
      sources: ['Indian Institute of Science history (founded 1909)', 'docs/16 takeoff-era sources (the Itihaas pack)', 'Kempegowda tradition (Katha frame); ISRO HQ, Bengaluru'] },
    { id: 'sriharikota', lab: 'e', era: 12, name: 'Sriharikota', state: 'AP', x: 421.3, y: 859.7, kind: 'vidya',
      ...
      sources: ['ISRO: SLV-3 and Rohini (18 July 1980); Satish Dhawan Space Centre SHAR', 'ISRO: Chandrayaan-3 landing (23 August 2023)'] }
  ],
