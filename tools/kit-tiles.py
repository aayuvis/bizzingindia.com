...
TILES = {
    ...
    "cr-millet":   (mix(T["leaf"], T["stone"], .42), "rows", T["gold"]),
    "cr-sesame":   (mix(T["leaf"], T["cream"], .40), "rows", T["white"]),
    "cr-gram":     (mix(T["leaf"], T["indigo"], .22), "rows", T["leaf"]),
    "cr-cotton":   (mix(T["leaf"], T["stone"], .48), "rows", T["white"]),
    "cr-sugarcane": (mix(T["leaf"], T["ink"], .18), "rows", T["leaf"]),
