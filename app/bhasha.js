...
var DEVANAGARI = {
  ...
  vowels: [
    { char: 'अ',         name: 'a',  roman: 'a',  audio: 'hi/a',  group: 'svar', short: true },
    { char: 'आ',         name: 'aa', roman: 'ā',  audio: 'hi/aa', group: 'svar', short: false, pairOf: 'a' },
    { char: 'इ',         name: 'i',  roman: 'i',  audio: 'hi/i',  group: 'svar', short: true },
    { char: 'ई',         name: 'ii', roman: 'ī',  audio: 'hi/ii', group: 'svar', short: false, pairOf: 'i' },
    { char: 'उ',         name: 'u',  roman: 'u',  audio: 'hi/u',  group: 'svar', short: true },
    { char: 'ऊ',         name: 'uu', roman: 'ū',  audio: 'hi/uu', group: 'svar', short: false, pairOf: 'u' },
    { char: 'ऋ',         name: 'ri', roman: 'ṛ',  audio: 'hi/ri', group: 'svar', short: true },
    { char: 'ए',         name: 'e',  roman: 'e',  audio: 'hi/e',  group: 'svar', short: false },
    { char: 'ऐ',         name: 'ai', roman: 'ai', audio: 'hi/ai', group: 'svar', short: false },
    { char: 'ओ',         name: 'o',  roman: 'o',  audio: 'hi/o',  group: 'svar', short: false },
    { char: 'औ',         name: 'au', roman: 'au', audio: 'hi/au', group: 'svar', short: false },
    { char: 'अं',   name: 'am', roman: 'aṁ', audio: 'hi/am', group: 'svar', sign: true },
    { char: 'अः',   name: 'ah', roman: 'aḥ', audio: 'hi/ah', group: 'svar', sign: true }
  ],
  ...
  consonants: [
    { char: 'क', name: 'ka',   r: 'k',   audio: 'hi/ka',   group: 'velar' },
    { char: 'ख', name: 'kha',  r: 'kh',  audio: 'hi/kha',  group: 'velar' },
    { char: 'ग', name: 'ga',   r: 'g',   audio: 'hi/ga',   group: 'velar' },
    { char: 'घ', name: 'gha',  r: 'gh',  audio: 'hi/gha',  group: 'velar' },
    { char: 'ङ', name: 'nga',  r: 'ṅ',   audio: 'hi/nga',  group: 'velar' },
    { char: 'च', name: 'cha',  r: 'c',   audio: 'hi/cha',  group: 'palatal' },
    { char: 'छ', name: 'chha', r: 'ch',  audio: 'hi/chha', group: 'palatal' },
    { char: 'ज', name: 'ja',   r: 'j',   audio: 'hi/ja',   group: 'palatal' },
    { char: 'झ', name: 'jha',  r: 'jh',  audio: 'hi/jha',  group: 'palatal' },
    { char: 'ञ', name: 'nya',  r: 'ñ',   audio: 'hi/nya',  group: 'palatal' },
    { char: 'ट', name: 'tta',  r: 'ṭ',   audio: 'hi/tta',  group: 'retroflex' },
    { char: 'ठ', name: 'ttha', r: 'ṭh',  audio: 'hi/ttha', group: 'retroflex' },
    { char: 'ड', name: 'dda',  r: 'ḍ',   audio: 'hi/dda',  group: 'retroflex' },
    { char: 'ढ', name: 'ddha', r: 'ḍh',  audio: 'hi/ddha', group: 'retroflex' },
    { char: 'ण', name: 'nna',  r: 'ṇ',   audio: 'hi/nna',  group: 'retroflex' },
    { char: 'त', name: 'ta',   r: 't',   audio: 'hi/ta',   group: 'dental' },
    { char: 'थ', name: 'tha',  r: 'th',  audio: 'hi/tha',  group: 'dental' },
    { char: 'द', name: 'da',   r: 'd',   audio: 'hi/da',   group: 'dental' },
    { char: 'ध', name: 'dha',  r: 'dh',  audio: 'hi/dha',  group: 'dental' },
    { char: 'न', name: 'na',   r: 'n',   audio: 'hi/na',   group: 'dental' },
    { char: 'प', name: 'pa',   r: 'p',   audio: 'hi/pa',   group: 'labial' },
    { char: 'फ', name: 'pha',  r: 'ph',  audio: 'hi/pha',  group: 'labial' },
    { char: 'ब', name: 'ba',   r: 'b',   audio: 'hi/ba',   group: 'labial' },
    { char: 'भ', name: 'bha',  r: 'bh',  audio: 'hi/bha',  group: 'labial' },
    { char: 'म', name: 'ma',   r: 'm',   audio: 'hi/ma',   group: 'labial' },
    { char: 'य', name: 'ya',   r: 'y',   audio: 'hi/ya',   group: 'semivowel' },
    { char: 'र', name: 'ra',   r: 'r',   audio: 'hi/ra',   group: 'semivowel' },
    { char: 'ल', name: 'la',   r: 'l',   audio: 'hi/la',   group: 'semivowel' },
    { char: 'व', name: 'va',   r: 'v',   audio: 'hi/va',   group: 'semivowel' },
    { char: 'श', name: 'sha',  r: 'ś',   audio: 'hi/sha',  group: 'sibilant' },
    { char: 'ष', name: 'shha', r: 'ṣ',   audio: 'hi/shha', group: 'sibilant' },
    { char: 'स', name: 'sa',   r: 's',   audio: 'hi/sa',   group: 'sibilant' },
    { char: 'ह', name: 'ha',   r: 'h',   audio: 'hi/ha',   group: 'sibilant' }
  ],
...
var GURMUKHI = {
  ...
  bearers: [
    ...
    { char: 'ਅ', name: 'aira', audio: 'pa/aira', carries: ['a', 'aa', 'ai', 'au'] },
    { char: 'ੲ', name: 'iri',  audio: 'pa/iri',  carries: ['i', 'ii', 'e'] }
  ],
  vowels: [
    { char: 'ਅ', name: 'a',  roman: 'a',  audio: 'pa/v-a',  group: 'svar', bearer: 'ਅ', short: true },
    { char: 'ਆ', name: 'aa', roman: 'ā',  audio: 'pa/v-aa', group: 'svar', bearer: 'ਅ', short: false, pairOf: 'a' },
    { char: 'ਇ', name: 'i',  roman: 'i',  audio: 'pa/v-i',  group: 'svar', bearer: 'ੲ', short: true },
    { char: 'ਈ', name: 'ii', roman: 'ī',  audio: 'pa/v-ii', group: 'svar', bearer: 'ੲ', short: false, pairOf: 'i' },
    { char: 'ਉ', name: 'u',  roman: 'u',  audio: 'pa/v-u',  group: 'svar', bearer: 'ੳ', short: true },
    { char: 'ਊ', name: 'uu', roman: 'ū',  audio: 'pa/v-uu', group: 'svar', bearer: 'ੳ', short: false, pairOf: 'u' },
    { char: 'ਏ', name: 'e',  roman: 'e',  audio: 'pa/v-e',  group: 'svar', bearer: 'ੲ', short: false },
    { char: 'ਐ', name: 'ai', roman: 'ai', audio: 'pa/v-ai', group: 'svar', bearer: 'ਅ', short: false },
    { char: 'ਓ', name: 'o',  roman: 'o',  audio: 'pa/v-o',  group: 'svar', bearer: 'ੳ', short: false },
    { char: 'ਔ', name: 'au', roman: 'au', audio: 'pa/v-au', group: 'svar', bearer: 'ਅ', short: false }
  ],

  /* The 32 sound-carrying akhar: ਸ ਹ, then five vargas of five, then the
     four semivowels plus ੜ. */
  consonants: [
    { char: 'ਸ', name: 'sassa',    r: 's',  audio: 'pa/sassa',    group: 'sibilant' },
    { char: 'ਹ', name: 'haha',     r: 'h',  audio: 'pa/haha',     group: 'sibilant' },
    { char: 'ਕ', name: 'kakka',    r: 'k',  audio: 'pa/kakka',    group: 'velar' },
    { char: 'ਖ', name: 'khakha',   r: 'kh', audio: 'pa/khakha',   group: 'velar' },
    { char: 'ਗ', name: 'gagga',    r: 'g',  audio: 'pa/gagga',    group: 'velar' },
    { char: 'ਘ', name: 'ghagga',   r: 'gh', audio: 'pa/ghagga',   group: 'velar' },
    { char: 'ਙ', name: 'nganga',   r: 'ṅ',  audio: 'pa/nganga',   group: 'velar' },
    { char: 'ਚ', name: 'chacha',   r: 'c',  audio: 'pa/chacha',   group: 'palatal' },
    { char: 'ਛ', name: 'chhachha', r: 'ch', audio: 'pa/chhachha', group: 'palatal' },
    { char: 'ਜ', name: 'jajja',    r: 'j',  audio: 'pa/jajja',    group: 'palatal' },
    { char: 'ਝ', name: 'jhajja',   r: 'jh', audio: 'pa/jhajja',   group: 'palatal' },
    { char: 'ਞ', name: 'nyanya',   r: 'ñ',  audio: 'pa/nyanya',   group: 'palatal' },
    { char: 'ਟ', name: 'tainka',   r: 'ṭ',  audio: 'pa/tainka',   group: 'retroflex' },
    { char: 'ਠ', name: 'thattha',  r: 'ṭh', audio: 'pa/thattha',  group: 'retroflex' },
    { char: 'ਡ', name: 'dadda',    r: 'ḍ',  audio: 'pa/dadda',    group: 'retroflex' },
    { char: 'ਢ', name: 'dhadda',   r: 'ḍh', audio: 'pa/dhadda',   group: 'retroflex' },
    { char: 'ਣ', name: 'nanna',    r: 'ṇ',  audio: 'pa/nanna',    group: 'retroflex' },
    { char: 'ਤ', name: 'tatta',    r: 't',  audio: 'pa/tatta',    group: 'dental' },
    { char: 'ਥ', name: 'thatha',   r: 'th', audio: 'pa/thatha',   group: 'dental' },
    { char: 'ਦ', name: 'dada',     r: 'd',  audio: 'pa/dada',     group: 'dental' },
    { char: 'ਧ', name: 'dhada',    r: 'dh', audio: 'pa/dhada',    group: 'dental' },
    { char: 'ਨ', name: 'nana',     r: 'n',  audio: 'pa/nana',     group: 'dental' },
    { char: 'ਪ', name: 'pappa',    r: 'p',  audio: 'pa/pappa',    group: 'labial' },
    { char: 'ਫ', name: 'phapha',   r: 'ph', audio: 'pa/phapha',   group: 'labial' },
    { char: 'ਬ', name: 'babba',    r: 'b',  audio: 'pa/babba',    group: 'labial' },
...
function ladder(items) {
  return [
    { id: 's0', n: 0, name: 'Sunna',     en: 'Listening',  desc: 'Ear first. Spoken words and phrases, listen and point, no script at all.',
      outcome: 'Understands and answers common spoken words.', script: false, types: ['listenPoint'], items: items.s0 },
    { id: 's1', n: 1, name: 'Varnamala', en: 'The letters', desc: 'Every letter: its shape, its sound, its sound family.',
      outcome: 'Recognises and writes every letter.', script: true, types: ['soundMatch', 'oddOneOut'], items: items.s1 },
    ...
    { id: 's5', n: 5, name: 'Baat-cheet', en: 'Conversation', desc: 'Conversation scenarios: greeting elders, the market, the phone call to Nani.',
      outcome: 'Holds a real short conversation.', script: true, types: ['listenPoint', 'wordBuild'], items: items.s5 },
    { id: 's6', n: 6, name: 'Padhna',    en: 'Reading',     desc: 'Graded readers, and the conjuncts you need to get through them.',
      outcome: 'Reads a page of real text.', script: true, types: ['conjunctSplit', 'wordBuild', 'oddOneOut'], items: items.s6 },
    { id: 's7', n: 7, name: 'Likhna',    en: 'Writing',     desc: 'Handwriting, dictation, and short paragraph writing.',
      outcome: 'Writes a paragraph.', script: true, types: ['wordBuild', 'barakhadi'], items: items.s7 }
  ];
}
