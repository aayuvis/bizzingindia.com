...
STYLE = (
    ...
    "RAMA AND KRISHNA ALWAYS HAVE LUMINOUS BLUE SKIN — a clear, unmistakable soft blue, "
    "the way every temple image and devotional painting shows them — with a golden nimbus "
    "behind the head, a gold crown or peacock feather, and yellow silk. The blue is "
    "iconography rather than complexion: it is how these figures have been painted for "
    "centuries and it is how a child recognises them at a glance. Vishnu likewise. "
    "Everyone else has warm, natural, unbleached Indian skin across the honest range of "
    "real Indian faces. "
    "The people are the subject, not the scenery: they are placed close to the viewer and "
    "large in the frame — head-and-shoulders to three-quarter length — so every face and "
    "expression reads clearly. Landscape supports them; it never swallows them. "
